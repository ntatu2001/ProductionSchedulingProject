    ...
    public class TabuSearch
    {
        ...
        public static double objectValue(List<int> solution, DataTable workTable, List<JobInfor> bestListWorkInfor, Dictionary<string, List<JobInfor>> productionDeviceDict)
        {
            ...
            foreach (int job in solution)
            {
                ...
                var firstDateStart = DateTime.ParseExact("01/02/2023", "dd/MM/yyyy", System.Globalization.CultureInfo.InvariantCulture);
                if ((job - 1) == 0)
                {
        ...
        /// <param name="workTable"></param>
        /// <returns></returns>
        public static List<int> tabuSearch(DataTable workTable, DataTable workCenterTable,
                                                         ...
                                                         DataTable bomTable)
        {
            ...
            List<int> bestSolution = tabuSearch(workTable, workCenterTable, productTable, partnerTable, bomTable);
